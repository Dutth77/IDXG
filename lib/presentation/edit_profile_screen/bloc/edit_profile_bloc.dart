import 'package:equatable/equatable.dart';import 'package:flutter/material.dart';import '/core/app_export.dart';import 'package:aswini_s_application5/presentation/edit_profile_screen/models/edit_profile_model.dart';import 'package:aswini_s_application5/data/models/me/get_me_resp.dart';import 'dart:async';import 'package:aswini_s_application5/data/repository/repository.dart';import 'package:fluttertoast/fluttertoast.dart';part 'edit_profile_event.dart';part 'edit_profile_state.dart';/// A bloc that manages the state of a EditProfile according to the event that is dispatched to it.
...
_onInitialize(EditProfileInitialEvent event, Emitter<EditProfileState> emit, ) async  { emit(state.copyWith(editProfileFullNameController: TextEditingController(), editProfileEmailController: TextEditingController(), editProfileAddressController: TextEditingController(), editProfilePasswordController: TextEditingController()));
