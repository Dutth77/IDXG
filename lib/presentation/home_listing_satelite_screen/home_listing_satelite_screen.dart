...
static Widget builder(BuildContext context) { return BlocProvider<HomeListingSateliteBloc>(create: (context) => HomeListingSateliteBloc(HomeListingSateliteState(homeListingSateliteModelObj: HomeListingSateliteModel()))..add(HomeListingSateliteInitialEvent()), child: HomeListingSateliteScreen()); } 
@override Widget build(BuildContext context) { return BlocBuilder<HomeListingSateliteBloc, HomeListingSateliteState>(builder: (context, state) {return SafeArea(child: Scaffold(body: SizedBox(height: 693.v, width: double.maxFinite, child: GoogleMap(mapType: MapType.normal, initialCameraPosition: CameraPosition(target: LatLng(37.43296265331129, -122.08832357078792), zoom: 14.4746), onMapCreated: (GoogleMapController controller) {googleMapController.complete(controller);}, zoomControlsEnabled: false, zoomGesturesEnabled: false, myLocationButtonEnabled: false, myLocationEnabled: false)), bottomNavigationBar: _buildBottomBar(context)));}); } 
/// Section Widget
