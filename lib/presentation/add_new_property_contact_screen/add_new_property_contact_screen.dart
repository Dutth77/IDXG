import 'package:aswini_s_application5/widgets/app_bar/custom_app_bar.dart';import 'package:aswini_s_application5/widgets/app_bar/appbar_leading_iconbutton.dart';import 'package:aswini_s_application5/widgets/app_bar/appbar_subtitle_two.dart';import 'package:aswini_s_application5/widgets/custom_elevated_button.dart';import 'package:aswini_s_application5/widgets/custom_phone_number.dart';import 'package:country_pickers/country.dart';import 'package:country_pickers/country_pickers.dart';import 'models/add_new_property_contact_model.dart';import 'package:flutter/material.dart';import 'package:aswini_s_application5/core/app_export.dart';import 'bloc/add_new_property_contact_bloc.dart';
...
static Widget builder(BuildContext context) { return BlocProvider<AddNewPropertyContactBloc>(create: (context) => AddNewPropertyContactBloc(AddNewPropertyContactState(addNewPropertyContactModelObj: AddNewPropertyContactModel()))..add(AddNewPropertyContactInitialEvent()), child: AddNewPropertyContactScreen()); } 
...
/// Section Widget
Widget _buildPhoneNumber(BuildContext context) { return BlocBuilder<AddNewPropertyContactBloc, AddNewPropertyContactState>(builder: (context, state) {return CustomPhoneNumber(country: state.selectedCountry ?? CountryPickerUtils.getCountryByPhoneCode('1'), controller: state.phoneNumberController, onTap: (Country value) {context.read<AddNewPropertyContactBloc>().add(ChangeCountryEvent(value: value));});}); } 
/// Section Widget
